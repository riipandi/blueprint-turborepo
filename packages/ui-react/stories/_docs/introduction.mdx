...
<Meta title="Introduction" parameters={{ viewMode: 'docs', previewTabs: { canvas: { hidden: true } } }} />
...
Components support both light and dark themes through CSS variables and Tailwind configuration.
Colors, spacing, and other design tokens can be customized to match your brand.
...
Components are built with maintainability and reusability in mind. Contributions should follow
the established patterns and include proper documentation.
